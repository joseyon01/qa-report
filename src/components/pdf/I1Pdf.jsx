...
export const I1Pdf = (props) => {
  ...
  let value_B = "";
  let operational_C_I = "";
  let operational_C_II = "";
  let operational_C_III = "";
  let value_C = "";
  let operational_D_I = "";
  let value_E = "";
  let value_F = "";
  let operational_G_I = "";
  let operational_G_IV = "";
  let operational_G_V = "";
  let operational_G_VI = "";
  let operational_H_I = "";
  let operational_H_II = "";
  let operational_H_III = "";
  ...
  const getOperational = async () => {
    try {
      ...
      operational_C_I = data?.OPERATIONAL_C_I;
      operational_C_II = data?.OPERATIONAL_C_II;
      operational_C_III = data?.OPERATIONAL_C_III;
      value_C = data?.OPERATIONAL_C_IV;
      operational_D_I = data?.OPERATIONAL_D_I;
      value_E = data?.OPERATIONAL_E;
      value_F = data?.OPERATIONAL_F;
      operational_G_I = data?.OPERATIONAL_G_I;
      operational_G_IV = data?.OPERATIONAL_G_IV;
      operational_G_V = data?.OPERATIONAL_G_V;
      operational_G_VI = data?.OPERATIONAL_G_VI;
      operational_H_I = data?.OPERATIONAL_H_I;
      operational_H_II = data?.OPERATIONAL_H_II;
      operational_H_III = data?.OPERATIONAL_H_III;
      operational_NOTE = data?.OPERATIONAL_NOTE;
      value_I = data?.OPERATIONAL_I_I;
      operational_OPENING = data?.OPERATIONAL_OPENING;
      operational_CLOSING = data?.OPERATIONAL_CLOSING;
      value_J = data?.OPERATIONAL_I_II;
    } catch (error) {
      console.error("error", error);
    }
  };
