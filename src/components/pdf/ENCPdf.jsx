...
export const ENCPdf = (props) => {
  ...
  let operational_B_II_II = "";
  let operational_B_III = "";
  let operational_B_IV = "";
  let operational_B_V_I = "";
  let operational_B_V_II = "";
  let operational_B_VI_I = "";
  let operational_B_VI_II = "";
  let operational_B_VII = "";
  let operational_B_VIII = "";
  let operational_D_I = "";
  ...
  const getOperational = async () => {
    try {
      ...
      operational_B_II_II = data?.OPERATIONAL_B_II_II;
      operational_B_III = data?.OPERATIONAL_B_III;
      operational_B_IV = data?.OPERATIONAL_B_IV;
      operational_B_V_I = data?.OPERATIONAL_B_V_I;
      operational_B_V_II = data?.OPERATIONAL_B_V_II;
      operational_B_VI_I = data?.OPERATIONAL_B_VI_I;
      operational_B_VI_II = data?.OPERATIONAL_B_VI_II;
      operational_B_VII = data?.OPERATIONAL_B_VII;
      operational_B_VIII = data?.OPERATIONAL_B_VIII;
