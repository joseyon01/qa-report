          ...
          <Row className="sub-question">
            <Col xs={23}>
              <Row>
                ...
                <Col xs={23}>
                  <Form.Item name={OPERATIONAL_B_I_I}>
              ...
              <Row>
                ...
                <Col xs={23}>
                  <Form.Item name={OPERATIONAL_B_I_II}>
                    <Input style={{ width: 150 }} size="small" required />
                  </Form.Item>
                </Col>
              </Row>
              <Row>
                ...
                <Col xs={23}>
                  <Form.Item name={OPERATIONAL_B_I_III}>
                    <Input style={{ width: 150 }} size="small" required />
                  </Form.Item>
                </Col>
              </Row>
              <Row>
                ...
                <Col xs={23}>
                  <Form.Item name={OPERATIONAL_B_I_IV}>
                    <Input style={{ width: 150 }} size="small" required />
                  </Form.Item>
                </Col>
              </Row>
              <Row>
                ...
                <Col xs={23}>
                  <Form.Item name={OPERATIONAL_B_I_V}>
                    <Input style={{ width: 150 }} size="small" required />
                  </Form.Item>
                </Col>
              </Row>
